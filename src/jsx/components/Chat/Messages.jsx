...
//Images
import group1 from './../../../images/group/g1.jpg';
import group2 from './../../../images/group/g2.jpg';
import group3 from './../../../images/group/g3.jpg';
import group4 from './../../../images/group/g4.jpg';
						...
						<div className="card-body p-0">
							<div className="row">
								<Tab.Container defaultActiveKey="All">
									<div className="col-3" id="sideMenu" style={menuStyles}>
										<div className="p-4">
											<div className="d-flex align-items-center justify-content-between mb-3">
												<div>
													<span className="fs-24 font-w700 mb-0 me-2">Inbox</span>
													<span className="fs-18 font-w600 text-light">(2,456)</span>
												</div>
												<div className="plus-bx row">
													<Link to={"#"}><i className="fas fa-plus"></i></Link>
													{!isCollapsed ? <button onClick={toggleMenu} ><i class="fas fa-bars"></i></button> : null}
												</div>
											</div>
											<div className="d-flex align-items-center project-tab message-tab">
												<div className="card-tabs">
													<Nav as="ul" className="nav nav-tabs">
														...
														<Nav.Item as="li" className="nav-item">
															<Nav.Link className="nav-link" eventKey="Social">Social</Nav.Link>
														</Nav.Item>
														<Nav.Item as="li" className="nav-item">
															<Nav.Link className="nav-link" eventKey="Updates">Updates</Nav.Link>
														</Nav.Item>
													</Nav>
												</div>
											</div>
										...
										<div className="dlab-scroll chat-sidebar" id="chatSidebar">
											<span className="m-3 d-block">TEAM</span>
											<div className="chat-bx d-flex active mb-2 border-bottom">
												...
												<div className="w-100">
													<div className="d-flex mb-1 align-items-center">
														<span className="fs-16 text-black">Fillow Designer Team</span>
														<span className="fs-12 ms-auto">2m ago</span>
													</div>
											...
											<div className="recent-msg py-3 chat-bx">
												<div className="d-flex justify-content-between align-items-center">
													<span className="fs-16">RECENT MESSAGE</span>
											...
											<div className="chat-bx d-flex border-bottom">
												...
												<div className="w-100">
													<div className="d-flex mb-1 align-items-center">
														<span className="fs-16 text-black">Skylar Dorwart</span>
														<span className="fs-12 ms-auto">2m ago</span>
													</div>
													<div>
														<p className="mb-0">I remember that project due is tomorrow.</p>
											...
											<div className="chat-bx d-flex border-bottom">
												...
												<div className="w-100">
													<div className="d-flex mb-1 align-items-center">
														<span className="fs-16 text-black">Kierra Curtis</span>
														<span className="fs-12 ms-auto">2m ago</span>
													</div>
													<div>
														<p className="mb-0">I remember that project due is tomorrow.</p>
											...
											<div className="chat-bx d-flex border-bottom">
												...
												<div className="w-100">
													<div className="d-flex mb-1 align-items-center">
														<span className="fs-16 text-black">Qudsiya Sabrin</span>
														<span className="fs-12 ms-auto">2m ago</span>
													</div>
													<div>
														<p className="mb-0">I remember that project due is tomorrow.</p>
								...
								<div className="col-9" id="chat">
									<div className="d-flex justify-content-between align-items-center border-bottom px-4 pt-4 flex-wrap">
										<div className="d-flex align-items-center pb-3">
											<div className="plus-bx  ">
												{isCollapsed ? <button onClick={toggleMenu}><i class="fas fa-arrow-left"></i></button> : null}
											</div>
									...
									<PerfectScrollbar className=" dlab-scroll chat-box-area" id="chatArea">
										<div className="chat-box-area dz-scroll" id="chartBox">
											<div className="media my-4  justify-content-start align-items-start">
												<div className="image-box me-sm-4 me-2">
													<img src={group1} alt="" className="rounded-circle img-1" />
											...
											<div className="media mb-4 justify-content-end align-items-end">
												...
												<div className="image-box ms-sm-4 ms-2 mb-4">
													<img src={pic3} alt="" className="rounded-circle img-1" />
									...
									<div className="card-footer border-0 type-massage">
										...
										<div className="input-group-append d-flex justify-content-between flex-wrap">
											<div>
												<button type="button" className="btn pr-0">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<div>
												<button type="button" className="btn pr-0"><i className="fas fa-smile scale5 text-primary"></i></button>
												<button type="button" className="btn"><i className="fas fa-paperclip scale5 text-primary"></i></button>
												<button type="button" className="btn btn-primary rounded text-white"><i className="far fa-paper-plane me-2"></i>SEND</button>
											</div>
										</div>
									</div>
								</div>
