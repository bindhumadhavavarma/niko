        ...
        <>
            ...
            <div className="card-footer border-0 type-massage">
                ...
                <div className="input-group-append d-flex justify-content-between flex-wrap">
                    ...
                    {showEmojiPicker ? <EmojiPicker ></EmojiPicker> : null}
                    <div>
                        <button type="button" className="btn pr-0" onClick={() => setShowEmojiPicker(!showEmojiPicker)}><i className="fas fa-smile scale5 text-primary"></i></button>
